...
##     ## ####    ##    ##     ## ########  
 \033[1;32m  ╔════════════════════════════════════╗
 \033[1;32m  ║😈[•] Facebook : Md Riyad      
\033[1;32m   ║😈[•] Whatsapp : +8801729346558     
 \033[1;32m  ║😈[•] Github    : Riyadpk0
 ...
 \033[1;32m  ╚════════════════════════════════════╝"""
clear()
os.system("xdg-open https://youtube.com/channel/UC82eiZ0usVcWuOIJTUyKcfQ")
xxxx = str(len(ugen))
...
def main():
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100084700763298")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
